...
phrases=['ինչպես բողոք ներկայացնել','ինչ տվյալներ պետք է բողոքի համար','բողոքից հետո ինչ է լինում','ինչ ժամկետում պետք է բողոք ներկայացնել','մեկ տարվա ընթացքում բողոք','երեխայի բժշկական օգնության բողոք','8003']
